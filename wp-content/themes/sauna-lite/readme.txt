/*----------------------------------------------------------------------------*/
/* Sauna Lite Responsive WordPress Theme */
/*----------------------------------------------------------------------------*/

Theme Name      :   Sauna Lite
Theme URI       :   http://www.themescaliber.com/free/wp-sauna-spa-wordpress-theme/
Version         :   1.1.8
...
3 - Images used from Pixabay.
	...
	Our Services
		https://pixabay.com/en/scissors-hair-cut-comb-beauty-43984/
		https://pixabay.com/en/dryer-hair-hairdresser-1293118/
		https://pixabay.com/en/lipstick-make-up-piktogram-make-up-1397049/
	Screenshot Image
		https://pixabay.com/en/girl-hair-redhead-beauty-women-1378142/
...
Version 1.1.2
i) Fix errors related to enque and links.

Version 1.1.3
i) Translation and other errors fixed.

Version 1.1.4
i) Given used images link in readme.txt

Version 1.1.5
i) Bug fixes

Version 1.1.6
i) console error fixed

Version 1.1.7
i) Change the layout.
ii) Removed unused functions.
iii) Added the static section with pages.

Version 1.1.8
i)   Added translation tag.
ii)  Added rtl tag.
iii) Added Woocommerce.
iv)  Added hooks.
v)   Delete the changelog file and added in readme file.

Sauna Lite Premium version
==========================================================
Sauna Lite Premium version is compatible with GPL licensed.
